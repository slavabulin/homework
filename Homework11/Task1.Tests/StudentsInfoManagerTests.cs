...
namespace Task1.Tests
{
    ...
    public class StudentsInfoManagerTests
    {
        ...
        //    expectedVal.Add(new StudentsInfo() { StudentName = "ted", LessonName = new List<Test>() { new Test() { TestName = "math", TestDate = createTime, Assessment = 'F' } } });
        //    expectedVal.Add(new StudentsInfo() { StudentName = "john", LessonName = new List<Test>() { new Test() { TestName = "english", TestDate = createTime, Assessment = 'A' } } });
        //    //act
        ...
        //        Assert.AreEqual(enumExpectedVal.Current.StudentName, enumRetVal.Current.StudentName);
        //        IEnumerator<Test> enumRetTests = enumRetVal.Current.LessonName.GetEnumerator();
        //        IEnumerator<Test> enumExpTests = enumExpectedVal.Current.LessonName.GetEnumerator();
